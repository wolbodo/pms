...
VALUES
    ('people', NULL, '{"required":["email","nickname"],"form":[{"title":"contact","fields":[["email","phone"]]}]}', -1),
    ('people','gid', '{}', -1),
    ('people','id', '{}', -1),
    ('people','valid_from', '{}', -1),
    ('people','valid_till', '{}', -1),
    ('people','email', '{"title":"Email address","type":"string","validate":{"pattern":"/^.*@.*$/"}}', -1),
    ('people','phone', '{"title":"Telephone number"}', -1),
    ('people','password_hash', '{}', -1),
    ('people','modified_by', '{}', -1),
    ('people','modified', '{}', -1),
    ('people','created', '{}', -1),
    ('people','nickname', '{"title":"Nickname"}', -1),
    ('people','firstname', '{}', -1),
    ('people','infix', '{}', -1),
    ('people','lastname', '{}', -1),
    ('people','street', '{}', -1),
