...
SELECT DISTINCT groups.id, permissions.id, -1 FROM
    (VALUES
        ...
        (array['read'],          array['member'],       array['email','phone','mobile','nickname','firstname','infix','lastname','street','housenumber','zipcode','city','state','country','functions','emergencyinfo','membertype','peopleince','favoritenumber','notes']),
        ...
        (array['read', 'write'], array['board'],        array['nickname','firstname','infix','lastname','birthdate','deathdate','boardnotes','functions','membertype','peopleince','frontdoor','cashregister']),
